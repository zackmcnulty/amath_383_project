...
% Draws phase plane for the fitzhugh nagumo model; plots several
% trajectories in V-W space to show behavior of system under these
% conditions. Finds and classifies stability of fixed points.
